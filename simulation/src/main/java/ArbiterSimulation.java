...
public class ArbiterSimulation {

    private final static Logger LOGGER = Logger.getLogger(ArbiterSimulation.class.getName());
        ...
        while (SystemMetrics.getInstance().getCompleted() < txnLimit) {
            ...
            switch (nextEvent.getEventType()) {
                ...
                case UPDATE_2:
                    ...
                    break;
                case ARBITER:
                    ArbiterEvent arbiterEvent = (ArbiterEvent) nextEvent;
                    new ArbiterAction().action(arbiterEvent);
                    break;
                case ABORT_CLEAN_UP:
